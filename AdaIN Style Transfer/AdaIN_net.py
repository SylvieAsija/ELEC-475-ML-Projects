...
class AdaIN_net(nn.Module):
    ...
    def forward(self, content, style, alpha=1):
        ...
        if self.training:  # training
            ...
            #
            #   your code here ...
            style_features = list(self.encode(style))
            content_features = list(self.encode(content))
            ...
            #
            #   your code here ...
            style_feature = list(self.encode(style))[-1]
            content_feature = list(self.encode(content))[-1]
            feat = self.adain(content_feat=content_feature, style_feat=style_feature)
